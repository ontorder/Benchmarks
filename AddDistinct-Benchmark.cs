...
| frozen_distinct     | 2,024.0 ns | 22.19 ns | 18.53 ns | 0.3242 |      - |    2040 B |
| sort_distinct       | 2,112.5 ns | 37.61 ns | 53.94 ns | 0.1411 |      - |     888 B |
| order_distinct      | 2,144.3 ns | 41.70 ns | 46.35 ns | 0.2480 |      - |    1576 B |
| immutable_distinct  | 2,897.7 ns | 33.31 ns | 27.81 ns | 0.2136 |      - |    1352 B |
...
| frozen_distinct     | 47.47 us | 111.68 us | 329.29 us | 13.050 us |   2.38 KB |
| builder_distinct    | 50.44 us | 114.09 us | 336.39 us | 12.000 us |   1.39 KB |
| immutable_distinct  | 55.45 us | 114.74 us | 338.33 us | 18.300 us |   1.71 KB |
...
| frozen_distinct     | 4,409.4 ns | 16.25 ns | 15.20 ns | 0.6409 |    4024 B |
| order_distinct      | 4,506.8 ns | 15.11 ns | 14.14 ns | 0.3052 |    1952 B |
| immutable_distinct  | 5,603.9 ns | 26.09 ns | 23.13 ns | 0.3357 |    2144 B |
...
| frozen_distinct     | 60.68 us | 104.66 us | 308.58 us | 25.650 us |   4.32 KB |
| immutable_distinct  | 67.53 us | 143.03 us | 421.73 us | 20.850 us |   2.48 KB |
...
| frozen_distinct     | 11.501 us | 0.1870 us | 0.2154 us | 1.4801 |   9.07 KB |
| immutable_distinct  | 14.636 us | 0.0707 us | 0.0590 us | 0.6256 |   3.88 KB |
...
| frozen_distinct     | 29.560 us | 0.3381 us | 0.2997 us | 29.546 us | 3.2959 |      - |  20.28 KB |
| immutable_distinct  | 30.189 us | 0.4020 us | 0.4128 us | 30.146 us | 1.1597 |      - |   7.21 KB |
...
| immutable_distinct  | 101.97 us | 133.28 us | 392.99 us | 57.200 us |    7.6 KB |
| frozen_distinct     | 121.89 us | 113.10 us | 333.48 us | 81.350 us |  20.67 KB |
*/
